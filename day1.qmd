...
* **If you are not comfortable making directories and using your personal filestore, we'll fix that now because it's important!**
...
Once you start making more complex projects you'll need to write scripts , 
:::
...
(Go to Objects, functions, packages and pipes tutorial)
...
### Using the data in calculations
...
## Other packages for descriptive statistics (for advanced users)
