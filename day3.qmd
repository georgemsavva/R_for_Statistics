...
Powerpoint slides are here: [day3.pptx](./day3.pptx)

An explanation/breakdown of the code for a typical ggplot2 graph is here: [flipbook.html](./flipbook.html)
...
What are the different reasons we might make plots of the data?  Which plots did we make in Day 2, and why?
...
# Discuss real example (not included)


# Some tips for making a good graph
...
* Plot estimates and confidence intervals of important estimands, not groups 
